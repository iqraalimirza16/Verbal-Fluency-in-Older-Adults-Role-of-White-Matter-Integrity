...
INPUT_CSV    = "Memolife_animals_snafu_FINAL.csv"      # fluency data cleaned by Senna
...
# Load data for all metrics (Senna's cleaning already applied)
...
# Uses Senna's cleaned data (synonym replacements already applied)
# Missing words imputed with value of 12 years (Beitchman et al., 2008)
aoa = snafu.wordStat(
    fluencydata.labeledlists,
    data=AOA_FILE,
    missing=12
...
# Uses Senna's cleaned data (synonym replacements already applied)
# Missing words imputed with Zipf value of 1.07 (Rofes et al., 2023)
